...
class ProjectPage(Page):
    ...
    teaser_intro = models.TextField(blank=True, help_text='This text will appear below teaser', max_length='540')
    ...
    show_on_front = models.BooleanField(help_text="Select if this content is listed on the front page")
    
    content_panels = Page.content_panels + [
        FieldPanel('date'),
        FieldPanel('show_on_front', help_text="Select if this content is listed on the front page"),
